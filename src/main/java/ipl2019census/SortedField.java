...
public class SortedField {
    public enum Field {
        AVERAGE,STRIKE_RATE,SIXES_AND_FOURS, WKT_WITH_AVG,BATTING_BLOWING_AVG, WICKET_AVERAGE, HIGHSCORE, SIX, RUN,AVGBOWL_WITH_STRIKERATE,
    ...
    public static Comparator getField(SortedField.Field field)
    {
        ...
        sortFieldComparator.put(Field.MAXRUN_WITH_GREATAVG, maxrunComparator.thenComparing(avgBolComparator));
        sortFieldComparator.put(Field.AVGBOWL_WITH_STRIKERATE, avgBolComparator.thenComparing(avgBolComparator));
